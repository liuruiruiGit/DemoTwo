        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuGUID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MenuName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MenuStata = table.Column<bool>(type: "bit", nullable: false),
                    MenuCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MenuPerple = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleStata = table.Column<bool>(type: "bit", nullable: false),
                    RoleCreatePerple = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuGUID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RoleMenuTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RoleMenuPerple = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleMenuInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LogGUID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserStata = table.Column<bool>(type: "bit", nullable: false),
                    UserCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KeyApp = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleGUID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserRoleTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserRolePerple = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleInfo", x => x.Id);
                });
